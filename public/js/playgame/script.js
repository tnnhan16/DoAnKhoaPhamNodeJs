...
socket.on("CountDownStart", function(data){
    ...
    console.log("Hellllllllllllasdasd", data);
    if (data==0){
        ...
        success: function (data) {
            ...
            if (data.result == 1){
                ...
                if(data.question.question_flag + 1 <= data.maxQuestion){
                    ...
                    //showQuetions(data.question, data.answers); //calling showQestions function
                    //queCounter(data.question.question_flag + 1, data.maxQuestion); //passing que_numb value to queCounter
